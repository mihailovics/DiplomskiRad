   ...
   <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-6 ">
                <div class="checkout__form__input">
                    <p>Kategorija</p>
                    <input type="text" name="kategorija" name="kategorija">
                </div>
                </div>
                <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="checkout__form__input">
            ...
            <div class="col-lg-12 col-xl-12" id="update">
                ...
                <input type="submit" value="Dodaj artikl" name="dodaj">
            </div>
        </div>
        <?php
        ...
        if(isset($_POST["dodaj"])){
             ...
             if(!$izvor){
                ...
                $upit = "INSERT into artikl2 (naziv, kolicina, kategorija, proizvodjac, slika, datum, cena, opis) values (?,?,?,?,?,?,?,?)";
                $danas = date("Y-m-d");
