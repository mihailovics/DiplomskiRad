        ...
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="checkout__form__input">
                    <p>Ime</p>
                    <input type="text" value="<?php echo $_SESSION["Ime"];?>" name="ime">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="checkout__form__input">
                    <p>Prezime</p>
                    <input type="text" value="<?php echo $_SESSION["Prezime"];?>" name="prezime" >
                </div>
            </div>
            <div class="col-lg-6 ">
                <div class="checkout__form__input">
                ...
                <div class="checkout__form__input">
                    <p>Adresa</p>
                    <input type="text" value="<?php echo $_SESSION["Adresa"];?>" name="adresa" >
                </div>
                </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="checkout__form__input">
                    <p>Broj telefona</p>
                    <input type="text" value="<?php echo $_SESSION["Telefon"];?>" name="telefon">
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="checkout__form__input">
            ...
            <div class="col-lg-12 col-xl-12" id="update">
                <input type="submit" value="izmeni" name="update">
            </div>
            <?php
                    if(isset($_POST["update"])){
                    $upit = "update korisnik1 set Ime = ?, Prezime = ?, Email = ?, Lozinka = ?, Adresa = ?, Telefon = ?
                    where ID = ?";
                    $kreni = $con->prepare($upit);
                    $lozinka = $_POST["lozinka"];
                    $hashed = password_hash($lozinka,PASSWORD_DEFAULT);
                    $kreni->bind_param("ssssssi",$_POST['ime'],$_POST['prezime'],$_POST['email'],$hashed,$_POST['adresa'],$_POST['telefon'],$_SESSION['ID']);
                    $kreni->execute();
