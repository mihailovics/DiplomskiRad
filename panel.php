   ...
   <div class="row">
    <div class="tabela">
        ...
        <?php 
            ...
            $em = $_SESSION["ID"];
            $upit = "SELECT * FROM korisnik1 where ID != '" . $em . "'";
            $rez = $con->query($upit);
            while($konacno = $rez->fetch_assoc()){
                ...
                <tr>
                    ...
                    <td>
                        <a href="edit-korisnik.php?editid=<?php echo ($konacno['Email']);?>" >Edit</a>
                        <a href="delete.php?delid=<?php echo ($konacno['Email']);?>" >Delete</a>
                    </td>
                </tr>
           <?php } ?>
        </tbody>
